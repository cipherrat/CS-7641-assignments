...
python run_experiment.py --ica --dataset1 --dim 18 --skiprerun --verbose --threads -1 > ica-dataset1-clustering.log 2>&1
python run_experiment.py --ica --dataset2 --dim 4 --skiprerun --verbose --threads -1 > ica-dataset2-clustering.log 2>&1

python run_experiment.py --pca --dataset1 --dim 17 --skiprerun --verbose --threads -1 > pca-dataset1-clustering.log 2>&1
...
python run_experiment.py --rf  --dataset2 --dim 17 --skiprerun --verbose --threads -1 > rf-dataset2-clustering.log  2>&1
